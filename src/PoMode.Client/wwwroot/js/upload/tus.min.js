/*! tus-js-client v4.3.1 (dist/tus.min.js) - MIT License, Copyright (c) 2015 tus - Resumable File Uploads.
 *  https://github.com/tus/tus-js-client - vendored unmodified apart from the dropped source-map comment
 *  (no map is shipped). Served from this origin rather than a CDN at runtime, so the uploader loads
 *  wherever the page itself does. UMD build: imported for its side effect, it sets window.tus. */
